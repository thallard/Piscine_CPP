...
/*   Updated: 2021/04/03 12:22:18 by thallard         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
    return "\e[91mError : Grade execution is to low.\e[0m";
}
...
// Setters
void Form::setName(std::string Name) { this->name = Name; }
void Form::setisSigned(bool value) { isSigned = value; }
void Form::setGradeToExec(int grade) { gradeToExec = grade; }
void Form::setGradeToSign(int grade) { gradeToSign = grade; }